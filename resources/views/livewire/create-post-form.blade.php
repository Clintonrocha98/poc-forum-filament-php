<div class="bg-white dark:bg-gray-900 p-6 rounded-lg shadow border dark:border-gray-700 space-y-4">
    <form wire:submit.prevent="submit" class="space-y-4">
        ...
        <div class="flex justify-end border-t pt-4 dark:border-gray-700">
            <button type="submit"
                class="px-4 py-2 text-sm rounded dark:bg-gray-600 bg-gray-400 dark:hover:bg-gray-500 hover:bg-gray-700 text-white">
                Publicar
            </button>
        </div>
    </form>
